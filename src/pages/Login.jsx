...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 flex items-center justify-center">
      <div className="w-full max-w-md h-[100vh] relative overflow-hidden bg-slate-950 shadow-2xl border-x border-white/10 flex flex-col justify-center">
        
        {/* Background pan & zoom wrapper */}
        <motion.div 
          className="absolute inset-0 z-0 pointer-events-none"
          initial={{ scale: 1.3, x: -10, y: -20 }}
        ...
        {/* Form contents - delayed fade in to wait for the pan & zoom camera effect */}
        <div className="relative z-10 w-full flex items-center justify-center p-4">
          <motion.div 
            initial={{ opacity: 0, y: 30, scale: 0.96 }}
            animate={{ opacity: 1, y: 0, scale: 1 }}
            transition={{ delay: 2.0, duration: 0.8, ease: [0.34, 1.56, 0.64, 1] }}
            className="w-full"
          >
            {/* Logo */}
                ...
                {!isLogin && (
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 bg-white/[0.03] border border-white/[0.08] rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 focus:bg-white/[0.06] transition-all text-sm"
                      required
                    />
                  </div>
                )}
